...
async def seed():
    ...
    _ct = {
        "consulting_approved": ("Randevun onaylandı - {{site_name}}", "<h2 style=\"margin:0 0 14px;color:#fff;font-size:22px\">Randevun onaylandı</h2><p>Merhaba {{name}},</p><p><strong>{{datetime}}</strong> tarihli bire bir danışmanlık randevun onaylandı. Görüşme <strong>Google Meet</strong> üzerinden yapılacaktır; katılım linki en geç randevu saatinde paylaşılacak ve öğrenci panelinde görünecektir.</p><div style=\"margin:24px 0\"><a href=\"{{panel_url}}\" style=\"background:#FFB800;color:#07090f;padding:12px 26px;border-radius:9px;text-decoration:none;font-weight:bold\">Panelime Git</a></div>"),
        ...
        "consulting_meet": ("Danışmanlık Google Meet linkin hazır - {{site_name}}", "<h2 style=\"margin:0 0 14px;color:#fff;font-size:22px\">Google Meet linkin hazır 🎥</h2><p>Merhaba {{name}},</p><p><strong>{{datetime}}</strong> tarihli bire bir danışmanlık görüşmen için Google Meet katılım linkin hazır. Randevu saatinde aşağıdaki butondan katılabilirsin.</p><div style=\"margin:24px 0\"><a href=\"{{meet_link}}\" style=\"background:#FFB800;color:#07090f;padding:12px 26px;border-radius:9px;text-decoration:none;font-weight:bold\">Google Meet ile Katıl</a></div><p style=\"font-size:13px;color:#8a92a6\">Linke öğrenci panelinden de ulaşabilirsin: {{panel_url}}</p>"),
        "consulting_granted": ("Danışmanlık hakkın tanımlandı - {{site_name}}", "<h2 style=\"margin:0 0 14px;color:#fff;font-size:22px\">Danışmanlık hakkın hazır! 🎓</h2><p>Merhaba {{name}},</p><p>Ödemen başarıyla alındı ve <strong>bire bir danışmanlık hakkın</strong> hesabına tanımlandı. Öğrenci panelindeki <strong>Bire Bir Danışmanlık</strong> sekmesinden sana uygun gün ve saati seçerek randevunu oluşturabilirsin.</p><p style=\"color:#8a92a6\">Görüşmeler <strong>Google Meet</strong> üzerinden yapılır; onay sonrası katılım linkin panelinde görünür.</p><div style=\"margin:24px 0\"><a href=\"{{panel_url}}\" style=\"background:#FFB800;color:#07090f;padding:12px 26px;border-radius:9px;text-decoration:none;font-weight:bold\">Randevu Oluştur</a></div>"),
    }
